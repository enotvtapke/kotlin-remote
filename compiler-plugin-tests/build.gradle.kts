...
//    testImplementation(project(":compiler-plugin"))
    testImplementation(libs.compiler.plugin)
...
//    testDataClasspath(projects.utils)
    ...
    testDataClasspath(libs.ktor.utils)
    testDataClasspath(libs.serialization.core)
}
...
//    dependsOn(project(":krpc:krpc-core").tasks.getByName("jvmJar"))
    ...
    systemPropertyLogged("kotlinx.rpc.globalRootDir", "/home/enotvtapke/work/kotlin-remote")
