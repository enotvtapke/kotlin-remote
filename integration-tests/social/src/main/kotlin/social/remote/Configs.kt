...
object WebBffConfig : RemoteConfig { override val client: RemoteClient = remoteClient("http://localhost:8201") }
object MobileBffConfig : RemoteConfig { override val client: RemoteClient = remoteClient("http://localhost:8202") }
...
val WebBffContext = WebBffConfig.asContext()
val MobileBffContext = MobileBffConfig.asContext()
