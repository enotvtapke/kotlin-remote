...
class RemoteClassInitializer(private val ctx: RemoteIrContext) {
    ...
    private fun initStubClass(stubClass: IrClass, remoteClass: IrClass) {
        ...
        // Find the FIR-generated primary constructor
        val existingConstructor = stubClass.constructors.firstOrNull { it.isPrimary }
        val stubId = if (existingConstructor != null) {
            // Use the existing FIR-generated constructor
            ...
            // The constructor should already have the id parameter from FIR
            existingConstructor.parameters.firstOrNull { it.name == ctx.properties.stubId.owner.name }
                ?: error("FIR-generated constructor missing id parameter")
        } else {
            // Fallback: create constructor if not generated by FIR
